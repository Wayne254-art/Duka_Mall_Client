...
import { AiFillQuestionCircle, AiOutlineGoogle } from 'react-icons/ai'
        ...
        <div>
            ...
            <div className='bg-slate-200 mt-4'>
                <div className='w-full justify-center items-center p-4'>
                    <div className='grid md:grid-cols-1 grid-cols-2 md:w-[100%] lg:w-[60%]  mx-auto bg-white rounded-md'>
                        <div className='p-6 lg:p-8'>
                        <div className='h-[70px] flex justify-center items-center'>
                        <div className='w-[180px] h-[50px]'>
                            <img className='w-full h-full' src={`${FRONTEND_URL}/images/logo.png`} alt="logo" />
                        </div>
                    </div>
                            <h2 className='text-center w-full text-xl text-slate-600 font-bold'>Welcome Back!</h2>
                            <div>
                                ...
                                <Link to='/forgot-password' className='flex flex-row items-center justify-center m-4 hover:underline hover:text-gray-800 text-gray-900 font-medium text-md'><AiFillQuestionCircle className='text-xl text-red-600' /> Forgot Pasword?</Link>
                                ...
                                <button className='w-full py-2 bg-orange-500 shadow hover:shadow-orange-500/30 text-white rounded-md flex justify-center items-center gap-2 mb-3'>
                            ...
                            <div className='text-center text-slate-600 pt-1'>
                                <p> <a target='_black' className='text-blue-500' href={`${DASHBOARD_URL}/register`}>Register a seller account</a></p>
                            </div>
                        </div>
                        <div className='md:hidden w-full h-full py-4 pr-4'>
                            <img className='w-full h-[95%]' src={`${FRONTEND_URL}/images/login.jpg`} alt="" />
                        </div>
                    </div>
                </div>
            </div>
