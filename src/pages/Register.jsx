                ...
                <div className='w-full justify-center items-center p-4'>
                    <div className='grid md:grid-cols-1 grid-cols-2 md:w-[100%] lg:w-[60%]  mx-auto bg-white rounded-md'>
                        ...
                        <div className='w-[180px] h-[50px]'>
                            ...
                            <h2 className='text-center w-full text-xl text-slate-600 font-bold'>Register an Account Today!</h2>
                            <div>
                            ...
                            <div className='text-center text-slate-600 pt-1'>
                                <p> <a target='_black' className='text-blue-500' href={`${DASHBOARD_URL}/login`}>Login a seller account</a></p>
                            </div>
                        </div>
