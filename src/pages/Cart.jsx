...
const Cart = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("../public/images/banner/cart.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                ...
                <div className='w-[85%] lg:w-[90%] md:w-[90%] sm:w-[90] mx-auto py-16'>
                    {
                        cart_products.length > 0 || outofstock_products.length > 0 ? <div className='flex flex-wrap'>
                                ...
                                <div className='pr-3 md-lg:pr-0'>
                                    <div className='flex flex-col gap-3'>
                                        <div className='bg-white p-4'>
                                            <h2 className='text-md text-green-500 font-semibold'>Shop Overview ({cart_products.length})</h2>
                                        </div>
                                        {
                                                        ...
                                                        <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                            ...
                                                            <div className='flex gap-2 flex-col'>
                                                                <div className='flex bg-slate-200 h-[30px] justify-center items-center text-xl'>
                                                                    <div
                                                                        onClick={() => pt.quantity > 1 && dec(pt.quantity, pt._id)}
                                                                        className={`px-3 ${pt.quantity <= 1 ? 'text-gray-400 cursor-not-allowed' : 'cursor-pointer'}`}
                                                                    >
                                                                        -
                                                                    </div>
                                                                    ...
                                                                    <div
                                                                        onClick={() => pt.quantity < pt.productInfo.stock && inc(pt.quantity, pt.productInfo.stock, pt._id)}
                                                                        className={`px-3 ${pt.quantity >= pt.productInfo.stock ? 'text-gray-400 cursor-not-allowed' : 'cursor-pointer'}`}
                                                                    >
                                                                        +
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className='bg-white p-4'>
                                                    {
                                                        ...
                                                        <div key={i} className='w-full flex flex-wrap'>
                                                            <div className='flex sm:w-full gap-2 w-7/12'>
                                                                <div className='flex gap-2 justify-start items-center'>
                                                                    <img className='w-[80px] h-[80px]' src={p.products[0].images[0]} alt={p.name} />
                                                                    <div className='pr-4 text-slate-600'>
                                                            ...
                                                            <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
                                                                <div className='pl-4 sm:pl-0'>
                                                                    <h2 className='text-lg text-orange-500'>Ksh.{p.products[0].price - Math.floor((p.products[0].price * p.products[0].discount) / 100)} </h2>
                                ...
                                <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
                                    {
                                        cart_products.length > 0 && <div className='bg-white p-3 text-slate-600 flex flex-col gap-3'>
                                            ...
                                            <div className='flex justify-between items-center'>
                                                <span>Total</span>
                                                <span className='text-lg text-orange-500'>Ksh.{price + shipping_fee}</span>
                                            </div>
                            ...
                            <div className="flex flex-col items-center justify-center gap-6">
                                ...
                                {/* Shop Now Button */}
                                <Link
                                    className="px-6 py-2 bg-indigo-500 text-white rounded-lg shadow-md hover:bg-indigo-600 transition duration-200"
                                    to="/shops"
                                >
                                    Shop Now
                                </Link>
