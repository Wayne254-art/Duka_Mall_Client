...
import { FaLinkedinIn, FaFacebookF, FaUser, FaLock, FaList, FaInstagram } from 'react-icons/fa'
import { AiFillHeart, AiFillShopping } from 'react-icons/ai'
import { FaXTwitter } from "react-icons/fa6";
import { Link, useLocation, useNavigate } from 'react-router-dom'
import { useSelector, useDispatch } from 'react-redux'
import { get_cart_products, get_wishlist_products } from '../store/reducers/cartReducer'
import { DASHBOARD_URL, FRONTEND_URL } from '../utils/config'
...
const Headers = () => {
    ...
    return (
        <>
                        ...
                        <div className='flex w-full justify-between items-center h-[50px] text-slate-500'>
                            <ul className='flex justify-start items-center gap-8'>
                                <li className='flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]'>
                                    <span><GrMail /></span>
                                    <Link to='mailto:support@dukamall.co.ke' className='hover:underline'>support@dukamall.co.ke</Link>
                                </li>
                                <Link to={`${DASHBOARD_URL}/register`} target="_blank" rel="noopener noreferrer" className='text-orange-600 underline hover:text-red-500'> Sell on DukaMall</Link>
                            </ul>
                            <div>
                                <div className='flex justify-center items-center gap-10'>
                                    ...
                                    <div className='flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute before:absolute before:h-[18px] before:bg-[#afafaf] before:w-[1px] before:-left-[20px]'>
                                        <img src={`${FRONTEND_URL}/images/language.png`} alt="language" />
                                    ...
                                    {
                                        userInfo ? <Link className='flex cursor-pointer justify-center items-center gap-2 text-sm hover:underline' to='/dashboard'>
                                            <span><FaUser /></span>
                        ...
                        <div className='h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap'>
                            <div className='md-lg:w-full w-3/12 md-lg:pt-4'>
                                <div className='flex justify-between items-center'>
                                    <Link to='/'>
                                        <img src={`${FRONTEND_URL}/images/logo.png`} alt="logo" />
                                    </Link>
                            ...
                            <div className='md-lg:w-full w-9/12'>
                                <div className='flex justify-between md-lg:justify-center items-center flex-wrap pl-8'>
                                    <ul className='flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden'>
                                        ...
                                        <li>
                                            <Link to={'/blog'} className={`p-2 block ${pathname === '/blog' ? 'text-[#7fad39]' : 'text-slate-600'}`}>Blog</Link>
                                        </li>
                                        <li>
                        ...
                        <div className='flex justify-start flex-col gap-6'>
                            ...
                            <div className='flex justify-star items-center gap-10'>
                                <div className='flex group cursor-pointer text-slate-800 text-sm justify-center items-center gap-1 relative after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px] after:absolute'>
                                    <img src={`${FRONTEND_URL}/images/language.png`} alt="" />
                                    <span><MdOutlineKeyboardArrowDown /></span>
                                    <ul className='absolute invisible transition-all to-12 rounded-sm duration-200 text-white p-2 w-[100px] flex flex-col gap-3 group-hover:visible group-hover:top-6 group-hover:bg-black z-10'>
                                        <li>Swahili</li>
                                        <li>English</li>
                            ...
                            <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                ...
                                <div className='flex justify-end flex-col gap-1'>
                                    <Link to='tel:254799703637' className='text-sm font-medium text-slate-700 cursor-pointer hover:underline'>+254-799-703-637</Link>
                                    <span className='text-xs'>support 24/7 Hrs</span>
                                </div>
                            </div>
                            ...
                            <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                                ...
                                <div className='w-4/12 block md-lg:hidden pl-2 md-lg:w-full md-lg:pl-0'>
                                    <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                        ...
                                        <div className='flex justify-end flex-col gap-1'>
                                            <Link to='tel:254799703637' className='text-md font-medium text-slate-700 cursor-pointer hover:underline'>+254-799-703-637</Link>
                                            <span className='text-sm'>support 24/7 Hrs</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            {/* <div className={` pb-4 fixed top-0 left-0 w-full bg-white shadow-md z-[9999] transition-transform duration-300 ${showFixedHeader ? 'translate-y-0' : '-translate-y-full'}`}>
            </div> */}
        </>
    )
}
